...
namespace Kamrad.Multimedia.Web.Menus
{
    public class MultimediaMenuContributor : IMenuContributor
    {
        private readonly IConfiguration _configuration;

        public MultimediaMenuContributor(IConfiguration configuration)
        {
        ...
        private Task ConfigureMainMenuAsync(MenuConfigurationContext context)
        {
            ...
            var l = context.GetLocalizer<MultimediaResource>();

            context.Menu.Items.Insert(0, new ApplicationMenuItem("Multimedia.Home", l["Menu:Home"], "~/"));
