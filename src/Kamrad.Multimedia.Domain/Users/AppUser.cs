...
namespace Kamrad.Multimedia.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update MultimediaDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update MultimediaEfCoreEntityExtensionMappings to extend the IdentityUser entity
